...
image: poachedchicken.webp
obsidianUIMode: preview
aliases:
  - Perfectly Poached Chicken Breasts
---

![[poachedchicken.webp|locr hs-med]]

## Ingredients

servings: Makes 4 poached chicken breast halves
...
**Doneness:**
Pull the chicken when the thickest part of the largest piece registers 150°F (65°C) on an instant-read thermometer, about 25 minutes. Keep the poaching liquid at its lowest setting (around a bare simmer) for the juiciest result.

**Uses:**
Once chilled in the ice bath, the chicken can be carved and served or incorporated into another recipe.
...
Wok, instant-read thermometer, lid
