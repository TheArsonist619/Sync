...
tags:
  - pie
  - flour
Source: Dessert Person by Claire Saffitz, page 333
Cuisine: American
Type: Base
Meal:
Difficulty: Easy
...
![[piedough.webp|hs-med locr]]

## Ingredients
servings: Makes enough for one 9-inch pie or tart crust ①
...
1. [ ] **Prepare the ice water and slice some of the butter:** Fill a 1-cup liquid measure with ice water and refrigerate it while you assemble the pie dough. Cut a 5 tablespoon block of the butter (2.5 oz / 71g) crosswise into ⅛-inch-thick slices (so you have lots of thin butter squares) and refrigerate.
2. [ ] **Mix the dry ingredients:** In a large bowl, whisk together the flour, sugar, and salt to combine.
...
- ① **Make extra:** Double this recipe and make two pieces of pie dough at a time, even if you only need one (see the Double Crust variation). It's always a good idea to keep an extra frozen crust on hand.
- ② **Keep the butter cold:** Work quickly while smashing the butter into the flour so it stays cold; if it starts to soften, place the whole bowl in the freezer to chill for several minutes.
- ③ **If the dough cracks:** Rolling straight from the fridge will likely crack it. If tempered dough cracks while rolling, it may be underhydrated — dribble 2 teaspoons of cold water across the surface (or spritz with a spray bottle), fold in half, wrap in plastic, and refrigerate for 30 minutes.
- ④ **Prevent shrinkage:** Press the dough firmly and thoroughly into the plate with your palms and fingertips, and firmly anchor the edges to the lip. This helps prevent shrinkage and encourages better browning.
- ⑤ **Reduce the temperature:** Don't forget to reduce the oven from 425°F to 350°F when baking the crust again after removing the weights. The lower second bake helps prevent cracking and shrinkage, especially for a liquidy filling.
- ⑥ **For custard pies:** If preparing the crust for a custard pie such as the [[Caramelized Honey Pumpkin Pie]], make sure it's fully baked through and at least a deep golden brown across the bottom before adding the filling. Liquidy custards generate steam that prevents the crust beneath from browning further, so a few dark spots on the edge are worth it to avoid a soggy bottom.
